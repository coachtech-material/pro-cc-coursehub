...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">カテゴリ作成</h1>
        <p class="mt-1 text-sm text-gray-500">新しいカテゴリを追加します</p>
    </div>

    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <form method="POST" action="{{ route('admin.categories.store') }}" x-data="{ submitting: false }" @submit="submitting = true">
            @csrf
